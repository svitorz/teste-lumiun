        ...
        <div class="max-w-7xl gap-y-5 flex flex-col mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div x-data="{ open: false }">
                    <button type="button" class="p-3 dark:text-white dark:bg-slate-950 rounded m-4 bg-slate-100 text-slate-950 hover:dark:bg-slate-200"  x-on:click="open = !open">How to use?</button>
                    <div class="fixed inset-0 bg-black bg-opacity-50"  x-show="open">
                        <div class="dark:bg-slate-950 bg-white dark:text-white p-8 rounded-lg shadow-lg">
